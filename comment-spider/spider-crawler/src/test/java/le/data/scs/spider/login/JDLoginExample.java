...
public class JDLoginExample {
    ...
    public static void main(String[] args) throws SpiderConfigException, CookieException, IOException, InterruptedException, LoginException {
        SeleniumTools.setDebug(false);
        LoginAction action = new JDLoginAction();
        SpiderCookieLogin login = ConfigFactory.getLogin(CrawlerType.JD.toString());
